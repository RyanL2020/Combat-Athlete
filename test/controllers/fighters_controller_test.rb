...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { image: @fighter.image, name: @fighter.name } }, as: :json
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { image: @fighter.image, name: @fighter.name } }, as: :json
    assert_response 200
  end
